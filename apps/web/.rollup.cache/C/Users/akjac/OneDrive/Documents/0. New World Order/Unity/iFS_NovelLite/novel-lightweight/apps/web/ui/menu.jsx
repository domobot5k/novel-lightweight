    ...
    return (<Popover>
      ...
      <PopoverContent className="w-52 divide-y divide-stone-200" align="end">
        ...
        <div className="p-2">
          ...
          {appearances.map(({ theme, icon }) => (<button key={theme} className="flex w-full items-center justify-between rounded px-2 py-1.5 text-sm text-stone-600 hover:bg-stone-100" onClick={() => {
